...
$(document).ready(function() {
  $("#blanks form").submit(function(event) {
    ...
    $("#blanks").hide();
    $("#hideAfter").hide();
    $("#story").animate({width: '100px'}, "slow").animate({width: '1000px'}, "slow").animate({width: '100px'}, "slow").animate({width: '1000px'}, "slow").animate({width: '100px'}, "slow").animate({width: '1000px'}, "slow").animate({width: '100px'}, "slow").animate({width: '1000px'}, "slow").animate({width: '100px'}, "slow").animate({width: '1000px'}, "slow")
